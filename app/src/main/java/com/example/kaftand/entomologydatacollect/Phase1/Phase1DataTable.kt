...
class Phase1DataTable (override var metaData: Phase1MetaData, override val nRows: Int) : TabularData<Phase1DataEntry> {
    override var dataArray = ArrayList<Phase1DataEntry>()

    init {
        val trap_id_array = arrayListOf<String>("ndani hajala",
                "ndani amekula", "ndani hajala", "ndani amekula")
        for (iRow in 0 until nRows) {
            dataArray.add(Phase1DataEntry(this.metaData))
